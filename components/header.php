<header class="bg-white shadow-md sticky top-0 z-[1001]">
    <div class="container mx-auto px-4 py-4">
        ...
        <!-- Mobile menu -->
        <div id="mobile-menu" class="lg:hidden hidden fixed top-16 left-0 right-0 bg-white shadow-lg z-50">
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white shadow-lg rounded-lg mx-4 mt-2">
                ...
                <div id="faq-submenu" class="pl-4 space-y-1 hidden">
                    ...
                    <a href="#"
                        class="text-gray-700 hover:bg-blue-50 hover:text-blue-600 block px-3 py-2 rounded-md text-base font-medium">Course
                        FAQ</a>
