...
<section class="py-16 bg-gradient-to-br from-blue-50 to-teal-50 shadow-lg">
    <div class="container mx-auto px-4 text-center">
        ...
        <form id="downloadForm" action="includes/process_download.php" method="POST" class="flex flex-col sm:flex-row gap-4 max-w-2xl mx-auto text-center items-center">
