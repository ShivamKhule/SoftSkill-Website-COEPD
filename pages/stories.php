...
<section class="py-16">
    <div class="container mx-auto px-4">
        <div class="text-center mb-12">
            ...
            <p class="text-gray-600 max-w-3xl mx-auto">Highlights of learner achievements and growth in communication, confidence, professional behavior, and job performance.</p>
        </div>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <div class="p-8">
                    <div class="flex items-center mb-6">
                        ...
                        <div class="ml-4">
                            <h3 class="text-xl font-bold"><?php echo $story['name']; ?></h3>
                            <p class="text-gray-600"><?php echo $story['role']; ?><?php echo !empty($story['company']) ? ', ' . $story['company'] : ''; ?></p>
                        </div>
                    </div>
                    
                    <div class="mb-6">
                        <h4 class="font-bold text-gray-800 mb-2">Before Training:</h4>
                        <p class="text-gray-600"><?php echo $story['before']; ?></p>
                    </div>
                    
                    <div class="mb-6">
                        <h4 class="font-bold text-gray-800 mb-2">After Training:</h4>
                        <p class="text-gray-600"><?php echo $story['after']; ?></p>
                    </div>
                    
                    <div class="mb-6">
                        <h4 class="font-bold text-gray-800 mb-2">Key Improvement:</h4>
                        <p class="text-gray-600"><?php echo $story['improvement']; ?></p>
                    </div>
...
<section class="py-16 bg-gray-50">
    <div class="container mx-auto px-4">
        <div class="text-center mb-12">
            ...
            <p class="text-gray-600 max-w-3xl mx-auto">The measurable results of our training programs.</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="text-center">
                ...
                <div class="text-lg">Career Advancement</div>
            </div>
            
            <div class="text-center">
                <div class="text-4xl font-bold text-blue-600 mb-2">250+</div>
                <div class="text-lg">Corporate Clients</div>
            </div>
        </div>
    </div>
</section>
...
<section class="py-16">
    <div class="container mx-auto px-4">
        <div class="text-center mb-12">
            ...
            <p class="text-gray-600 max-w-3xl mx-auto">Hear from our graduates about their learning experience and career growth.</p>
        </div>
        
        <div class="bg-white rounded-lg shadow-md p-8 max-w-4xl mx-auto">
            <div class="text-center">
                <div class="bg-gray-200 border-2 border-dashed rounded-xl w-24 h-24 mx-auto mb-6" />
                <p class="text-xl italic text-gray-700 mb-6">"The leadership training I received completely transformed my approach to managing my team. Within six months, our department productivity increased by 35%, and employee satisfaction scores reached an all-time high."</p>
                <div>
                    <h4 class="font-bold text-lg">Michael Rodriguez</h4>
...
<section class="py-16 bg-gradient-to-r from-blue-600 to-indigo-700 text-white">
    <div class="container mx-auto px-4 text-center">
        ...
        <div class="flex flex-col sm:flex-row justify-center gap-4">
            <a href="courses/" class="bg-white text-blue-600 hover:bg-gray-100 font-bold py-3 px-8 rounded-lg text-lg transition duration-300">Explore Courses</a>
