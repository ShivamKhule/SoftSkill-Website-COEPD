...
<section class="bg-gradient-to-r from-blue-600 to-teal-500 text-white py-20 animate-fade-in">
    <div class="container mx-auto px-4 text-center animate-slide-up">
        ...
        <p class="text-xl max-w-3xl mx-auto animate-fade-in-delay">Comprehensive soft skills programs designed for
...
<section class="py-16 bg-white">
    <div class="container mx-auto px-4">
        <div class="text-center mb-12 animate-fade-in">
            ...
            <p class="text-gray-600 max-w-3xl mx-auto">Explore our comprehensive range of soft skills training programs
                designed to meet your personal and professional development needs.</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 services-container">
            <?php foreach ($services as $index => $service): ?>
                <div
                    ...
                    <a href="<?php echo ($service['id'] == 'complete-program') ? 'schedule.php' : 'contact.php?service=' . $service['id']; ?>"
                ...
                <?php foreach ($program['structure'] as $monthIndex => $month): ?>
                    <div class="border border-gray-200 rounded-lg p-6 hover:border-blue-300 transition-colors">
                        <div class="text-center mb-4">
                            <span class="inline-block bg-blue-100 text-blue-800 font-bold px-4 py-2 rounded-full">Month
                                <?php echo ($monthIndex + 1); ?></span>
    ...
    <div class="container mx-auto px-4">
        <div class="flex flex-col lg:flex-row items-center gap-12 corporate-training-container">
            ...
            <div class="lg:w-1/2 animate-slide-in-right">
                ...
                <p class="text-gray-600 mb-6">We provide customized corporate soft-skills programs for teams and
                    organizations to enhance workplace communication, collaboration, and productivity.</p>
                ...
                <div class="space-y-4 mb-8">
                    <div class="flex items-start animate-fade-in-left delay-1">
                        ...
                        <span class="text-gray-700"><span class="font-semibold">Team Communication &
                                Collaboration</span> - Build cohesive teams with improved trust and cooperation</span>
                    </div>
                    <div class="flex items-start animate-fade-in-left delay-2">
                        <i class="fas fa-check-circle text-green-500 mt-1 mr-3 animate-rotate-in"></i>
                        <span class="text-gray-700"><span class="font-semibold">Leadership Development Programs</span> -
                            Cultivate authentic leaders who inspire teams</span>
                    </div>
                    <div class="flex items-start animate-fade-in-left delay-3">
                        <i class="fas fa-check-circle text-green-500 mt-1 mr-3 animate-rotate-in"></i>
                        <span class="text-gray-700"><span class="font-semibold">Customer Service Excellence</span> -
                            Equip your customer-facing teams with empathy and problem-solving skills</span>
                    </div>
                    <div class="flex items-start animate-fade-in-left delay-4">
                        <i class="fas fa-check-circle text-green-500 mt-1 mr-3 animate-rotate-in"></i>
                        <span class="text-gray-700"><span class="font-semibold">Change Management & Adaptability</span>
                            - Help employees navigate transitions and embrace innovation</span>
                    </div>
                    <div class="flex items-start animate-fade-in-left delay-5">
                        <i class="fas fa-check-circle text-green-500 mt-1 mr-3 animate-rotate-in"></i>
                        <span class="text-gray-700"><span class="font-semibold">Conflict Resolution & Workplace
                                Etiquette</span> - Develop skills to handle disagreements constructively</span>
                    </div>
                </div>

                <a href="<?php echo BASE_PATH; ?>/pages/contact.php?service=corporate"
                    class="inline-block bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-lg transition duration-300 transform hover:scale-105 shadow-md">Learn
                    About Corporate Programs</a>
            </div>
        </div>
    </div>
</section>
...
<section class="py-16 bg-gradient-to-r from-blue-600 to-teal-500 text-white animate-fade-in">
    <div class="container mx-auto px-4 text-center">
        ...
        <p class="text-xl mb-8 max-w-2xl mx-auto animate-fade-in-delay">Join our next batch or contact us to learn more
            about our training programs.</p>
        <div class="flex flex-col sm:flex-row justify-center gap-4 animate-fade-in-delay-2">
            <a href="<?php echo BASE_PATH; ?>/pages/schedule.php"
                class="bg-white text-blue-600 hover:bg-gray-100 font-bold py-3 px-8 rounded-lg text-lg transition duration-300 transform hover:scale-105 shadow-lg">View
                Schedule</a>
