<?php
// This is a template file for individual course pages
// It should be duplicated and customized for each specific course

$pageTitle = "Course Title - SoftSkills Academy";
include $_SERVER['DOCUMENT_ROOT'] . '/softskill_website/includes/functions.php';
$course = getCourseById('course-id'); // Replace 'course-id' with actual course ID
?>
