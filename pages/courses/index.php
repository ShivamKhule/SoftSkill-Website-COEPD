...
<section class="bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-20">
    <div class="container mx-auto px-4 text-center">
        ...
        <p class="text-xl max-w-3xl mx-auto">Comprehensive training programs designed to enhance your professional skills.</p>
    </div>
</section>
...
<section class="py-16">
    <div class="container mx-auto px-4">
        <div class="text-center mb-12">
            ...
            <p class="text-gray-600 max-w-3xl mx-auto">Choose from our wide range of specialized training programs tailored to your professional development needs.</p>
        </div>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden border border-gray-100">
                ...
                <div class="p-6">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <a href="<?php echo $course['id']; ?>.php" class="bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-lg text-sm transition duration-300">View Details</a>
                    </div>
                </div>
            </div>
            <?php endforeach; ?>
...
<section class="py-16 bg-gray-50">
    <div class="container mx-auto px-4">
        <div class="text-center mb-12">
            ...
            <p class="text-gray-600 max-w-3xl mx-auto">Choose the format that best fits your schedule and learning preferences.</p>
        </div>
...
<section class="py-16">
    <div class="container mx-auto px-4 text-center">
        ...
        <p class="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">Join our next batch or contact us to learn more about our training programs.</p>
        <div class="flex flex-col sm:flex-row justify-center gap-4">
            <a href="../schedule.php" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-8 rounded-lg text-lg transition duration-300">View Schedule</a>
            <a href="../contact.php" class="bg-white border-2 border-blue-600 text-blue-600 hover:bg-blue-50 font-bold py-3 px-8 rounded-lg text-lg transition duration-300">Contact Us</a>
        </div>
    </div>
</section>
