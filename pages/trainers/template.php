<?php
// This is a template file for individual trainer profiles
// It should be duplicated and customized for each specific trainer

$pageTitle = "Trainer Profile - SoftSkills Academy";
include '../../includes/functions.php';
$trainer = getTrainerById('trainer-id'); // Replace 'trainer-id' with actual trainer ID
